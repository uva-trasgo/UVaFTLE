...
icpx -fsycl -fsycl-targets=nvptx64-nvidia-cuda  -Xsycl-target-backend=nvptx64-nvidia-cuda --cuda-gpu-arch=sm_70 -O3 -DCUDA_DEVICE  -DBLOCK=512 -I./include/ arithmetic.o  ftle.o preprocess.o -o ftle-oneApi-buff
