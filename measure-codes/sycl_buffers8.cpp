...
int main(int argc, char *argv[]) {
...

 {
  ...
  ::buffer<int, 1> b_facesP[8] = {
   ::buffer(facesPerPoint + offsets_faces[0], range{static_cast<size_t>(v_points_faces[0])}),
   ::buffer(facesPerPoint + offsets_faces[1], range{static_cast<size_t>(v_points_faces[1])}),
   ::buffer(facesPerPoint + offsets_faces[2], range{static_cast<size_t>(v_points_faces[2])}),
   ::buffer(facesPerPoint + offsets_faces[3], range{static_cast<size_t>(v_points_faces[3])}),
   ::buffer(facesPerPoint + offsets_faces[4], range{static_cast<size_t>(v_points_faces[4])}),
   ::buffer(facesPerPoint + offsets_faces[5], range{static_cast<size_t>(v_points_faces[5])}),
   ::buffer(facesPerPoint + offsets_faces[6], range{static_cast<size_t>(v_points_faces[6])}),
   ::buffer(facesPerPoint + offsets_faces[7], range{static_cast<size_t>(v_points_faces[7])})
  };
  ::buffer<double, 1> b_logSqrt[8] = {
   ::buffer(logSqrt + offsets[0], range{static_cast<size_t>(v_points[0])}),
   ::buffer(logSqrt + offsets[1], range{static_cast<size_t>(v_points[1])}),
   ::buffer(logSqrt + offsets[2], range{static_cast<size_t>(v_points[2])}),
   ::buffer(logSqrt + offsets[3], range{static_cast<size_t>(v_points[3])}),
   ::buffer(logSqrt + offsets[4], range{static_cast<size_t>(v_points[4])}),
   ::buffer(logSqrt + offsets[5], range{static_cast<size_t>(v_points[5])}),
   ::buffer(logSqrt + offsets[6], range{static_cast<size_t>(v_points[6])}),
   ::buffer(logSqrt + offsets[7], range{static_cast<size_t>(v_points[7])})
  };
